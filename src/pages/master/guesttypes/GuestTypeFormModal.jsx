...
export default function GuestTypeFormModal({ show, handleClose, handleSubmit, defaultData }) {
    const [formData, setFormData] = useState(defaultData||{type:''});
    ...
    return (
        <Modal
            show={show}
            title={`${defaultData ? 'Edit':'Tambah'} Jenis Tamu`}
            onClose={handleClose}
            onSubmit={onSubmit}
            loading={loading}
            size="sm"
