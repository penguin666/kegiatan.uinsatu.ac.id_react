...
function EventIndex() {
    ...
    const fetchData = async () => {
        setLoadingData(true)
        try {
            const result = await get(`/roles?page=${page}&size=${rowsPerPage}&sortBy=${sorting.sortBy}&sortOrder=${sorting.sortOrder}&term=${search}`, accessToken, {});
    ...
    const handleSubmit = async (newData) => {
        try {
            ...
            if (editData) {
                result = await put(`/roles/${editData.id}`, accessToken, newData);
            } else {
                result = await post('/roles', accessToken, newData);
            }
    ...
    const handleConfirmed = async () => {
        setLoading(true)
        try {
            const result = await del(`/roles/${itemToDelete?.id}`, accessToken, {});
