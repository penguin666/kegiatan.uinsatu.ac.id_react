...
export default function EventParticipantForm({ handleSubmit, session, refresh}) {
    ...
    const fetchOptions = async () => {
        setLoading(true)
        try {
            const result = await get(`/events/${session.event_id}/sessions/${session.id}/participants/list-options?size=1000`, accessToken, {});
    ...
    return (
        <form onSubmit={onSubmit}>
            <h3 className="pb-2">Tambah Peserta Sesi</h3>
