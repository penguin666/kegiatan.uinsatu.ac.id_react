...
export default function MeetingDocumentation() {
    ...
    const fetchPhotos = async () => {
        setLoading(true)
        try {
            const result = await get(`/my-meetings/${meeting.id}/documentations?size=1000`, accessToken, {});
    ...
    const handleConfirmed = async () => {
        ...
        try {
            const result = await del(`/my-meetings/${meeting.id}/documentations/${itemToDelete?.id}`, accessToken, {});
